...
import {KeyAction, MacroTerminator} from './macro-api.common';
import type {IMacroAPI, ValidationResult} from './macro-api.common';
import {RawKeycodeSequenceAction} from './types';
import type {RawKeycodeSequence} from './types';
